-- Example default.lua file.
-- This file would be found in your Themes/Simply-Love-SM5/BGAnimations/ScreenEvaluation common/ folder.
-- Search for "EcfaScore.lua" to jump to the line you need to add.
-- Do not copy and paste this file, as your version of Simply Love may be different.
-- Instead, find your file in the folder and insert the line there.
-- When editing the file, be careful to use an editor that preserves line endings. On Windows, do not use Notepad.
...
for player in ivalues(Players) do
	...
	t[#t+1] = Def.ActorFrame{
		...
		-- ECFA score
		-- Insert this line here in your own default.lua to enable the score mod.
